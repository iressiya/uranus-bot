...
def record_visit(user_id, username, full_name):
    ...
    conn.commit()
    conn.close()
    logging.info("START from user_id=" + str(user_id) + " username=" + str(username) + " name=" + str(full_name))
...
async def cmd_start(message: Message):
    text = (
        "Привіт! Я Уранічний бот. Ретроградний Уран стартував ✨\n\n"
        "Я надсилатиму тобі короткий прогноз дня, прив'язаний саме до поточного етапу транзиту💫\n\n"
