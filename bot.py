...
# DB_PATH: якщо підключено Volume в Railway, вкажи там шлях (наприклад /data)
# через змінну DB_DIR. Якщо не підключено - база лежатиме в тимчасовій папці
# і буде стиратись при кожному редеплої.
...
async def activate_subscription(user_id, username, full_name):
    ...
    text = (
        "Підписку активовано! Щоденні уранічні підказки надходитимуть о 9:00.\n\n"
        + PAYMENT_INFO
    )
